...
export const APP_INFO = {
    en: {
        ...
        privacy: 'Settings, profiles, alarms and selected cities are stored locally on this device.',
        portalLabel: 'Visit Apps & Games'
    },
    hr: {
        ...
        freeLabel: 'Besplatno za upotrebu',
        privacy: 'Postavke, profili, alarmi i odabrani gradovi spremaju se lokalno na ovom uređaju.',
        portalLabel: 'Posjeti Apps & Games'
    },
    de: {
        ...
        privacy: 'Einstellungen, Profile, Alarme und ausgewählte Städte werden lokal auf diesem Gerät gespeichert.',
        portalLabel: 'Apps & Games besuchen'
    },
    it: {
        ...
        freeLabel: 'Utilizzo gratuito',
        privacy: 'Impostazioni, profili, sveglie e città selezionate vengono salvati localmente su questo dispositivo.',
        portalLabel: 'Visita Apps & Games'
    },
    es: {
        ...
        privacy: 'Los ajustes, perfiles, alarmas y ciudades seleccionadas se guardan localmente en este dispositivo.',
        portalLabel: 'Visitar Apps & Games'
    }
};
